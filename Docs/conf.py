...
breathe_default_project = "GameKit"
...
latex_documents = [
  (master_doc, 'GameKit.tex', u'GameKit Documentation',
...
man_pages = [
    (master_doc, 'GameKit', u'GameKit Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'GameKit', u'GameKit Documentation',
   author, 'GameKit', 'Unreal Engine Game Kit',
   'Miscellaneous'),
]
