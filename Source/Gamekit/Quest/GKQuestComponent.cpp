...
UGKQuestComponent::UGKQuestComponent()
{
    ...
    // features off to improve performance if you don't need them. PrimaryComponentTick.bCanEverTick = true;
...
// Called every frame
void UGKQuestComponent::TickComponent(float                        DeltaTime,
                                      ELevelTick                   TickType,
...
void UGKQuestComponent::GiveQuest(FName QuestName)
{
    ...
    AbilitySystemComponent->AddGameplayEventTagContainerDelegate(
            ...
            FGameplayEventTagMulticastDelegate::FDelegate::CreateUObject(this,
                                                                         &UGKQuestComponent::OnGameplayQuestEvent));
}
