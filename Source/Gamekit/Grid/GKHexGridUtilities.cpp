...
FIntPoint UGKHexGridUtilities::AxialRound(FVector2D p) { return CubeToAxial(CubeRound(AxialToCube(p))); }
...
float Distance(FIntVector a, FIntVector b) { return FMath::Max3(abs(a.X - b.X), abs(a.Y - b.Y), abs(a.Z - b.Z)); }
