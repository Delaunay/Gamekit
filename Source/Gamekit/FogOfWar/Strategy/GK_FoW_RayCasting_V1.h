...
class GAMEKIT_API UGKRayCasting_Line: public UGKFogOfWarStrategy
{
    ...
    void DrawFactionFog(class AGKFogOfWarActorTeam *FactionFog);
    ...
    virtual void DrawObstructedLineOfSight(class AGKFogOfWarActorTeam *FactionFog, UGKFogOfWarComponent *c);

    //! Draw the ligne of sight using a material (no collision)
    virtual void DrawUnobstructedLineOfSight(class AGKFogOfWarActorTeam *FactionFog, UGKFogOfWarComponent *c);

    void DrawUnobstructedLineOfSight_Draw(class AGKFogOfWarActorTeam *FactionFog, UGKFogOfWarComponent *c);
