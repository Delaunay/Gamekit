...
class UGKShadowCasting: public UGKFogOfWarStrategy
{
    ...
    void DrawFactionFog(class AGKFogOfWarActorTeam *FactionFog) override;

    void Stop() override;

    //! Draw the line of sight using the right method
    void DrawLineOfSight(class AGKFogOfWarActorTeam *FactionFog, class UGKFogOfWarComponent *c) override;
    ...
    //
    class AGKFogOfWarActorTeam *CurrentFaction;
