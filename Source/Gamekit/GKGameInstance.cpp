...
UGKGameInstanceBase::UGKGameInstanceBase()
	: SaveSlot(TEXT("SaveGame"))
	, SaveUserIndex(0)
{}

UGKSaveGame* UGKGameInstanceBase::GetCurrentSaveGame()
{
	return CurrentSaveGame;
}

void UGKGameInstanceBase::SetSavingEnabled(bool bEnabled)
{
...
bool UGKGameInstanceBase::WriteSaveGame()
{
	if (bSavingEnabled)
	{
		...
		UGameplayStatics::AsyncSaveGameToSlot(GetCurrentSaveGame(), SaveSlot, SaveUserIndex, FAsyncSaveGameToSlotDelegate::CreateUObject(this, &UGKGameInstanceBase::HandleAsyncSave));
		return true;
	}
	return false;
}
