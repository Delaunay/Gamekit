...
UGKAbilityTask_WaitForTargetData* UGKAbilityTask_WaitForTargetData::WaitForTargetDataUsingActor(UGameplayAbility* OwningAbility, 
																							    FName TaskInstanceName, 
																								TEnumAsByte<EGameplayTargetingConfirmation::Type> ConfirmationType, 
																								AGKAbilityTarget_Actor* InTargetActor)
{
	UGKAbilityTask_WaitForTargetData* MyObj = NewAbilityTask<UGKAbilityTask_WaitForTargetData>(OwningAbility, TaskInstanceName);		//Register for task list here, providing a given FName as a key
...
bool UGKAbilityTask_WaitForTargetData::ShouldProduceTargetData() const
{
	...
	const AGameplayAbilityTargetActor* CDO = CastChecked<AGameplayAbilityTargetActor>(TargetActor->GetClass()->GetDefaultObject());
...
void UGKAbilityTask_WaitForTargetData::InitializeTargetActor() const
{
	...
	TargetActor->TargetDataReadyDelegate.AddUObject(
		const_cast<UGKAbilityTask_WaitForTargetData*>(this),
...
void UGKAbilityTask_WaitForTargetData::OnTargetDataReplicatedCallback(const FGameplayAbilityTargetDataHandle& Data, FGameplayTag ActivationTag)
{
