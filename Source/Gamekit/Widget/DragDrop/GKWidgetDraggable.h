 ...
 *    :cpp:class:`UGKWidgetDragVisual` will try to restore the parent of :cpp:class:`UGKWidgetDraggable` on drag
 * failure. Nevertheless, failure to restore the parent will make the dragged widget disappear.
 *
 * .. note::
 *
